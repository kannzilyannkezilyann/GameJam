/**
 * @file   ItemSelectPlayerScript.cs
 *
 * @brief  アイテムセレクトシーンのプレイヤーに関するヘッダファイル
 *
 * @author 制作者名　深谷翔太
 *
 * @date   日付　2026/02/04
...
public class ItemSelectPlayerScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float inputX = 1.0f;
        if (m_body2d.transform.position.x >= m_stopPoint)
        {
            Vector2 stopPos = new Vector2(m_stopPoint, m_body2d.transform.position.y);
